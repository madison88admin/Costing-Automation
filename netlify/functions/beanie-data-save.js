...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('Search criteria:', {
      ...
      style_number: insertData.style_number
    });
    ...
    if (existingRecords && existingRecords.length > 0) {
      ...
      console.log(`Found ${existingRecords.length} existing record(s), updating...`);
      ...
      console.log('No existing records found, inserting new record...');
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: `Beanie data ${action} successfully`,
        action: action,
        data: result,
